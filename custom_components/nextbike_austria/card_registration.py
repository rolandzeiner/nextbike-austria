"""Lovelace JS module registration for Nextbike Austria.
...
class JSModuleRegistration:
    """Register the Nextbike Austria card JS module for Lovelace.
    ...
    async def _async_register_path(self) -> None:
        """Register the static HTTP path that serves the card JS file."""
        ...
        try:
            ...
            _LOGGER.debug("Path registered: %s -> %s", CARD_URL, card_path)
        except RuntimeError:
            _LOGGER.debug("Path already registered: %s", CARD_URL)
