    ...
    `}_renderPills(e,t,i){const s=[];if(this._config.show_ebikes&&"number"==typeof e&&Number.isFinite(e)&&e>0&&s.push(W`
      ...
      `)}for(let e=f+m+_;e<g;e++){const e=this._t("legend_empty");E.push(W`
        <div
          ...
          title=${e}
        ></div>
      `)}const T=t>s,P=f+m+_<g,R=m>0,M=_>0,H=this._t("rack_summary").replace("{available}",String(f)).replace("{capacity}",String(s));return W`
      <div class="rack-block">
        ...
        ${this._config.show_legend?this._renderLegend({accent:n,hasEbikes:v,hasOverflow:T,hasEmptyVisible:P,battery:x&&"number"==typeof r?{pct:r,color:Se(r)}:null,hasReservedVisible:R,hasDisabledVisible:M}):V}
      </div>
