...
`;let Ce=class extends he{constructor(){super(...arguments),this._config={type:"nextbike-austria-card",entities:[]},this._toggleStation=e=>{const t=[...this._config.entities||[]],i=t.findIndex(t=>t.entity===e),s=i>=0?t.filter((e,t)=>t!==i):[...t,{entity:e}];this._config={...this._config,entities:s},this._fire()},this._setBool=(e,t)=>{this._config={...this._config,[e]:t},this._fire()},this._setLayout=e=>{"stacked"!==e&&"tabs"!==e||(this._config={...this._config,layout:e},this._fire())}}static{this.styles=Ee}setConfig(e){this._config=ke(e)}_et(e){return function(e,t){const i=ve(e);return ye(me[i],["editor",t])??ye(me.en,["editor",t])??t}(this.hass,e)}_fire(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config}},bubbles:!0,composed:!0}))}render(){if(!this.hass)return Z;const e=$e(this.hass),t=this._config.entities||[],i=new Set(t.map(e=>e.entity)),s="tabs"===this._config.layout?"tabs":"stacked",r=!1!==this._config.show_rack;return q`
    ...
    `}_setActiveTab(e){Number.isFinite(e)&&e!==this._activeTab&&(this._activeTab=e)}_onTabKeydown(e,t,i){let s=t;switch(e.key){case"ArrowRight":s=(t+1)%i;break;case"ArrowLeft":s=(t-1+i)%i;break;case"Home":s=0;break;case"End":s=i-1;break;default:return}e.preventDefault(),this._setActiveTab(s),this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelectorAll('.tabs [role="tab"]');e?.[s]?.focus()})}_renderStation(e){const r=this.hass?.states[e.entity];if(!r)return q`<div class="empty-state">${this._t("no_entities_unavailable")}</div>`;const n=r.attributes||{},o=Number.isFinite(parseInt(r.state,10))?parseInt(r.state,10):0,a="number"==typeof n.capacity?n.capacity:null,l="number"==typeof n.num_docks_available?n.num_docks_available:null,c=function(e){const t=e?.vehicle_types_available;if(!Array.isArray(t))return null;let i=0;for(const e of t){if(!e||"object"!=typeof e)continue;const t=e,r=String(t.vehicle_type_id??""),n=t.count;s.has(r)&&"number"==typeof n&&Number.isFinite(n)&&(i+=n)}return i}(n),d="number"==typeof n.e_bike_avg_battery_pct?n.e_bike_avg_battery_pct:null,h="number"==typeof n.e_bike_range_samples?n.e_bike_range_samples:0,p=Array.isArray(n.e_bike_battery_list)?n.e_bike_battery_list:null,u=n.vehicle_type_names&&"object"==typeof n.vehicle_type_names?n.vehicle_type_names:{},b=Array.isArray(n.vehicle_types_available)?n.vehicle_types_available:[],g="number"==typeof n.bikes_reserved?n.bikes_reserved:0,f=Array.isArray(n.bikes_reserved_types)?n.bikes_reserved_types:[],_="number"==typeof n.bikes_disabled?n.bikes_disabled:0,m=Array.isArray(n.bikes_disabled_types)?n.bikes_disabled_types:[],v=n.system_id||"",y=t[v]||"var(--primary-color)",x=i[v]||v.replace(/^nextbike_/,""),$="string"==typeof n.rental_uri?n.rental_uri:"",w="string"==typeof n.friendly_name&&n.friendly_name.length>0,k=Se(n.friendly_name||e.entity),A="number"==typeof n.latitude&&"number"==typeof n.longitude?`https://www.google.com/maps/search/?api=1&query=${n.latitude},${n.longitude}`:null,S=1===o?this._t("bike"):this._t("bikes"),E=this._renderPills(c,l,a);return q`
      ...
      >
        ...
        <div class="hero">
          <div class="metric">
            <div class="metric-value">
              <span class="metric-num">${o}</span>
              ${null!==a?q`<span class="metric-of">/ ${a}</span>`:Z}
            </div>
        ...
        ${this._config.show_rack&&null!==a&&a>0?this._renderRack({bikes:o,ebikes:c,capacity:a,accent:y,batteryPct:d,batterySamples:h,batteryList:p,vehicleTypesAvailable:b,vehicleTypeNames:u,reservedCount:g,reservedTypes:f,disabledCount:_,disabledTypes:m}):Z}
    ...
    `}_renderPills(e,t,i){const s=[];if(this._config.show_ebikes&&"number"==typeof e&&Number.isFinite(e)&&e>0&&s.push(q`
      ...
      `)}return s}_renderRack(e){const{bikes:t,ebikes:i,capacity:r,accent:n,batteryPct:o,batterySamples:a,batteryList:l,vehicleTypesAvailable:c,vehicleTypeNames:d,reservedCount:h,reservedTypes:p,disabledCount:u,disabledTypes:b}=e,g=r,f=Math.min(t,r),_=Math.min(Number.isFinite(h)?h:0,Math.max(0,g-f)),m=Math.min(Number.isFinite(u)?u:0,Math.max(0,g-f-_)),v="number"==typeof i&&Number.isFinite(i)&&i>0,y=v?Math.min(f,i):0,x=!!this._config.show_battery&&"number"==typeof o&&a>0,$=x&&Array.isArray(l)?l:[],w=function(e,t){if(!Array.isArray(e))return null;for(const i of e){const e=String(i?.vehicle_type_id??"");if(s.has(e)&&t?.[e])return t[e]}return null}(c,d),k=function(e,t){const i=[];if(!Array.isArray(e))return i;for(const r of e){const e=String(r?.vehicle_type_id??""),n="number"==typeof r?.count&&Number.isFinite(r.count)?r.count:0;if(s.has(e)||n<=0)continue;const o=t?.[e]||"";for(let e=0;e<n;e++)i.push(o)}return i}(c,d);let A=0;const S=[];for(let e=0;e<f;e++){if(e<y){const t=$[e]||null,i=t?.type||w||this._t("legend_ebike");if(t&&x&&"number"==typeof t.pct){const e=t.pct,s=Ae(e),r=`${i} · ${Math.round(e)}%`;S.push(q`
            <div
      ...
      `)}const C=this._t("disabled");for(let e=0;e<m;e++){const t=b?.[e],i=t?`${t} · ${C}`:C;S.push(q`
        <div
          class="slot disabled"
          role="img"
          aria-label=${i}
      ...
      `)}for(let e=f+_+m;e<g;e++){const e=this._t("legend_empty");S.push(q`
        <div
          class="slot empty"
          role="img"
          aria-label=${e}
          title=${e}
        ></div>
      `)}const z=t>r,T=f+_+m<g,P=_>0,R=m>0,M=this._t("rack_summary").replace("{available}",String(f)).replace("{capacity}",String(r));return q`
      <div class="rack-block">
        <div class="rack" role="group" aria-label=${M}>
          ${S}
          ${z?q`<span
                class="rack-note"
                aria-label=${"+"+(t-r)}
        ...
        ${this._config.show_legend?this._renderLegend({accent:n,hasEbikes:v,hasOverflow:z,hasEmptyVisible:T,battery:x&&"number"==typeof o?{pct:o,color:Ae(o)}:null,hasReservedVisible:P,hasDisabledVisible:R}):Z}
      </div>
