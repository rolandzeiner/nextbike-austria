...
`;let ze=class extends oe{constructor(){super(...arguments),this._config={type:"nextbike-austria-card",entities:[]},this._computeLabel=e=>{const t=`ui.panel.lovelace.editor.card.generic.${e.name}`,i=this.hass?.localize?.(t);if(i)return i;const s=this._t(e.name);return s!==e.name?s:e.name},this._computeHelper=e=>{const t=`${e.name}_helper`,i=this._t(t);return i===t?void 0:i},this._onFormChanged=e=>{const t=e.detail.value,i=t.entities,s=Array.isArray(i)?i.filter(e=>"string"==typeof e&&e.length>0).map(e=>({entity:e})):[],n=Ae({...t,entities:s});this._config=n,function(e,t,i){const s=new CustomEvent(t,{detail:i,bubbles:!0,composed:!0});e.dispatchEvent(s)}(this,"config-changed",{config:n})}}static{this.styles=Ce}setConfig(e){this._config=Ae(e)}_t(e){return function(e,t){const i=fe(e);return me(ge[i]??ge.en,["editor",t])??me(ge.en,["editor",t])??t}(this.hass,e)}_schema(){return[{name:"entities",required:!0,selector:{entity:{domain:"sensor",integration:"nextbike_austria",multiple:!0}}},{name:"layout",selector:{select:{mode:"dropdown",options:[{value:"stacked",label:this._t("layout_stacked")},{value:"tabs",label:this._t("layout_tabs")}]}}},{type:"expandable",name:"display",title:this._t("section_display"),flatten:!0,schema:[{name:"hide_header",selector:{boolean:{}}},{name:"show_rack",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_battery",selector:{boolean:{}}},{name:"show_ebikes",selector:{boolean:{}}},{name:"show_docks",selector:{boolean:{}}},{name:"show_flags",selector:{boolean:{}}},{name:"show_timestamp",selector:{boolean:{}}},{name:"show_rent_button",selector:{boolean:{}}},{name:"hide_attribution",selector:{boolean:{}}}]}]}_formData(){const e=(this._config.entities??[]).map(e=>e.entity).filter(e=>"string"==typeof e&&e.length>0);return{...this._config,entities:e}}render(){return this._config?I`
    ...
    `}_renderEmpty(){const e=we(this.hass).length?"no_entities_picked":"no_entities_available";return I`<div class="empty-state" role="status">${this._t(e)}</div>`}_renderTabs(e){return I`
      <div class="tabs" role="tablist">
        ${e.map((t,i)=>{const s=this.hass?.states[t.entity]?.attributes||{},n="string"==typeof s.friendly_name&&s.friendly_name.length>0,r="string"==typeof s.station_display_name&&s.station_display_name?s.station_display_name:Ee(s.friendly_name||t.entity),a=i===this._activeTab;return I`
            ...
            >
              ${n?I`<span lang="de">${r}</span>`:r}
            </button>
          `})}
      </div>
    `}_setActiveTab(e){Number.isFinite(e)&&e!==this._activeTab&&(this._activeTab=e)}_onTabKeydown(e,t,i){let s=t;switch(e.key){case"ArrowRight":s=(t+1)%i;break;case"ArrowLeft":s=(t-1+i)%i;break;case"Home":s=0;break;case"End":s=i-1;break;default:return}e.preventDefault(),this._setActiveTab(s),this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelectorAll('.tabs [role="tab"]');e?.[s]?.focus()})}_renderStation(e,t){const i=this.hass?.states[e.entity];if(!i)return I`<div class="empty-state" role="status">${this._t("no_entities_unavailable")}</div>`;const s=i.attributes||{},n=Number.isFinite(parseInt(i.state,10))?parseInt(i.state,10):0,r="number"==typeof s.capacity?s.capacity:null,a="number"==typeof s.num_docks_available?s.num_docks_available:null,o=function(e){const t=e?.vehicle_types_available;if(!Array.isArray(t))return null;const i=xe(e);let s=0;for(const e of t){if(!e||"object"!=typeof e)continue;const t=e,n=String(t.vehicle_type_id??""),r=t.count;i.has(n)&&"number"==typeof r&&Number.isFinite(r)&&(s+=r)}return s}(s),l="number"==typeof s.e_bike_avg_battery_pct?s.e_bike_avg_battery_pct:null,c="number"==typeof s.e_bike_range_samples?s.e_bike_range_samples:0,d=Array.isArray(s.e_bike_battery_list)?s.e_bike_battery_list:null,h=s.vehicle_type_names&&"object"==typeof s.vehicle_type_names?s.vehicle_type_names:{},p=Array.isArray(s.vehicle_types_available)?s.vehicle_types_available:[],u=xe(s),b="number"==typeof s.bikes_reserved?s.bikes_reserved:0,g=Array.isArray(s.bikes_reserved_types)?s.bikes_reserved_types:[],f="number"==typeof s.bikes_disabled?s.bikes_disabled:0,m=Array.isArray(s.bikes_disabled_types)?s.bikes_disabled_types:[],_=s.system_id||"",v=be[_]||"var(--primary-color)",y="string"==typeof s.system_label&&s.system_label||_.replace(/^nextbike_/,""),x=$e(s.rental_uri),$="string"==typeof s.friendly_name&&s.friendly_name.length>0,w="string"==typeof s.station_display_name&&s.station_display_name?s.station_display_name:Ee(s.friendly_name||e.entity),k="number"==typeof s.latitude&&"number"==typeof s.longitude&&$e(`https://www.google.com/maps/search/?api=1&query=${s.latitude},${s.longitude}`)||null,A=1===n?this._t("bike"):this._t("bikes"),S=this._renderPills(o,a,r),E="number"==typeof t;return I`
      <section
        class="station"
        aria-label=${w}
        role=${E?"tabpanel":V}
        id=${E?`nbpanel-${t}`:V}
        aria-labelledby=${E?`nbtab-${t}`:V}
        tabindex=${E?"-1":V}
        style=${`--nb-accent:${v};`}
      >
        ${this._config.hide_header?V:I`<header class="header">
              <div class="icon-tile" aria-hidden="true">
                <ha-icon icon="mdi:bicycle"></ha-icon>
              </div>
              <div class="header-text">
                <h2 class="title">
                  ${$?I`<span lang="de">${w}</span>`:w}
                </h2>
    ...
    `}_renderPills(e,t,i){const s=[];if(this._config.show_ebikes&&"number"==typeof e&&Number.isFinite(e)&&e>0&&s.push(I`
      ...
      `)}return s}_renderRack(e){const{bikes:t,ebikes:i,capacity:s,accent:n,batteryPct:r,batterySamples:a,batteryList:o,vehicleTypesAvailable:l,vehicleTypeNames:c,ebikeIds:d,reservedCount:h,reservedTypes:p,disabledCount:u,disabledTypes:b}=e,g=s,f=Math.min(t,s),m=Math.min(h,Math.max(0,g-f)),_=Math.min(u,Math.max(0,g-f-m)),v="number"==typeof i&&Number.isFinite(i)&&i>0,y=v?Math.min(f,i):0,x=!!this._config.show_battery&&"number"==typeof r&&a>0,$=x&&Array.isArray(o)?o:[],w=v||g>0,k=w?function(e,t,i){if(!Array.isArray(e))return null;for(const s of e){const e=String(s?.vehicle_type_id??"");if(i.has(e)&&t?.[e])return t[e]}return null}(l,c,d):null,A=w?function(e,t,i){const s=[];if(!Array.isArray(e))return s;for(const n of e){const e=String(n?.vehicle_type_id??""),r="number"==typeof n?.count&&Number.isFinite(n.count)?n.count:0;if(i.has(e)||r<=0)continue;const a=t?.[e]||"";for(let e=0;e<r;e++)s.push(a)}return s}(l,c,d):[];let S=0;const E=[];for(let e=0;e<f;e++){if(e<y){const t=$[e]||null,i=t?.type||k||this._t("legend_ebike");if(t&&x&&"number"==typeof t.pct){const e=t.pct,s=Se(e),n=`${i} · ${Math.round(e)}%`;E.push(I`
            <div
              ...
              title=${n}
            ></div>
          `)}else{const e=x?`${i} · ${this._t("battery_unknown")}`:i;E.push(I`
            <div
              ...
              title=${e}
            ></div>
          `)}}else{const e=A[S++]||this._t("legend_bike");E.push(I`
          <div
            class="slot filled"
            role="img"
            aria-label=${e}
            ...
            title=${e}
          ></div>
        `)}}const C=this._t("reserved");for(let e=0;e<m;e++){const t=p?.[e],i=t?`${t} · ${C}`:C;E.push(I`
        <div
          class="slot reserved"
          role="img"
          aria-label=${i}
      ...
      `)}const z=this._t("disabled");for(let e=0;e<_;e++){const t=b?.[e],i=t?`${t} · ${z}`:z;E.push(I`
        <div
          class="slot disabled"
          role="img"
          aria-label=${i}
      ...
      `)}for(let e=f+m+_;e<g;e++){const e=this._t("legend_empty");E.push(I`
        <div
          class="slot empty"
          role="img"
          aria-label=${e}
          title=${e}
        ></div>
      `)}const T=t>s,P=f+m+_<g,M=m>0,R=_>0,H=this._t("rack_summary").replace("{available}",String(f)).replace("{capacity}",String(s));return I`
    ...
    `}_renderLegend(e){const{accent:t,hasEbikes:i,hasOverflow:s,hasEmptyVisible:n,battery:r,hasReservedVisible:a,hasDisabledVisible:o}=e,l=[I`
        <div class="legend-item">
          <dt class="legend-swatch" style=${`background:${t}`} aria-hidden="true"></dt>
          <dd>${this._t("legend_bike")}</dd>
        </div>
      `];if(i){const e=r?"background:linear-gradient(to top, #2ecc71 70%, color-mix(in srgb, #2ecc71 15%, transparent) 70%);outline:1px solid color-mix(in srgb, #2ecc71 60%, transparent);outline-offset:-1px;":`background:linear-gradient(135deg, ${t} 0%, ${t} 55%, #ffd740 55%, #ffd740 100%);`;l.push(I`
        <div class="legend-item">
      ...
      `),I`<dl class="legend">${l}</dl>`}_renderFlags(e){const t=[];return!1===e.is_installed&&t.push(I`
        <span class="flag err">
          <ha-icon icon="mdi:alert-circle"></ha-icon>${this._t("offline")}
        </span>
      `),!1===e.is_renting&&t.push(I`
        <span class="flag warn">
          <ha-icon icon="mdi:cancel"></ha-icon>${this._t("no_rental")}
        </span>
      `),!1===e.is_returning&&t.push(I`
        <span class="flag warn">
          <ha-icon icon="mdi:cancel"></ha-icon>${this._t("no_return")}
        </span>
      `),!0===e.is_virtual_station&&t.push(I`
        <span class="flag">
          <ha-icon icon="mdi:map-marker-radius"></ha-icon>${this._t("virtual_station")}
        </span>
      `),t.length?I`<div class="flags">${t}</div>`:V}_renderFooter(e,t){const i=!!this._config.show_rent_button&&!!t,s=this._config.show_timestamp?function(e,t){let i=null;if("number"==typeof e&&Number.isFinite(e))i=e;else if("string"==typeof e&&e.length>0){const t=Date.parse(e);Number.isFinite(t)&&(i=t/1e3)}if(null===i)return null;const s=Math.max(0,Math.floor(Date.now()/1e3-i));return s<10?t("now"):s<60?t("seconds_ago").replace("{n}",String(s)):s<3600?t("minutes_ago").replace("{n}",String(Math.floor(s/60))):t("hours_ago").replace("{n}",String(Math.floor(s/3600)))}(e.last_reported,e=>this._t(e)):null;return i||s?I`
      <div class="actions">
        ${i?I`
              <a
                class="btn-primary"
