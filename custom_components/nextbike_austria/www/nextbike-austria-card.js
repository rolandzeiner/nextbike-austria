...
`,ve=new Set(["143","183","200"]);function ye(e){const t=e?.e_bike_vehicle_type_ids;if(Array.isArray(t)&&t.length>0){const e=t.filter(e=>"string"==typeof e&&e.length>0);if(e.length>0)return new Set(e)}return ve}function xe(e){return"string"!=typeof e?"":/^https?:\/\//i.test(e)?e:""}function we(e){return e&&e.states?Object.keys(e.states).filter(t=>{if(!t.startsWith("sensor."))return!1;const i=e.states[t];if(!i)return!1;const s=i.attributes;return!!s&&"string"==typeof s.station_id&&"string"==typeof s.system_id&&s.system_id.startsWith("nextbike_")&&"string"==typeof s.attribution&&s.attribution.startsWith("Data: nextbike")}):[]}function $e(e){return"string"==typeof e?e.includes(".")?{entity:e}:null:e&&"object"==typeof e&&"string"==typeof e.entity?{entity:e.entity}:null}function ke(e){const t={...e||{}};"string"==typeof t.entity&&t.entity.includes(".")&&(Array.isArray(t.entities)&&0!==t.entities.length||(t.entities=[{entity:t.entity}])),delete t.entity;const i=Array.isArray(t.entities)?t.entities:[];return t.entities=i.map($e).filter(e=>null!==e),t.show_rack=!1!==t.show_rack,t.show_legend=!1!==t.show_legend,t.show_ebikes=!1!==t.show_ebikes,t.show_battery=!1!==t.show_battery,t.show_docks=!1!==t.show_docks,t.show_flags=!1!==t.show_flags,t.show_timestamp=!1!==t.show_timestamp,t.show_rent_button=!1!==t.show_rent_button,t.hide_header=!0===t.hide_header,t.hide_attribution=!0===t.hide_attribution,"tabs"!==t.layout&&(t.layout="stacked"),t}function Ae(e){return"number"==typeof e&&Number.isFinite(e)?e>=75?"#2ecc71":e>=50?"#8bc34a":e>=25?"#ffa726":"#e53935":"#2ecc71"}function Se(e,t){const i=e?.station_display_name;if("string"==typeof i&&i)return i;const s=e?.friendly_name;return String("string"==typeof s&&s?s:t).replace(/\s+(Bikes available|Räder verfügbar)$/,"")}const Ee=r`
  :host {
    color-scheme: light dark;
    display: block;
  }
...
`;function Ce(e,t,i,s){var n,r=arguments.length,a=r<3?t:s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a}class ze extends ae{static{this.styles=Ee}setConfig(e){this._config=ke(e)}_t(e){return function(e,t){const i=ge(e);return fe(be[i]??be.en,["editor",t])??fe(be.en,["editor",t])??t}(this.hass,e)}_schema(){return[{name:"entities",required:!0,selector:{entity:{multiple:!0,filter:{domain:"sensor",integration:"nextbike_austria"}}}},{name:"layout",selector:{select:{mode:"dropdown",options:[{value:"stacked",label:this._t("layout_stacked")},{value:"tabs",label:this._t("layout_tabs")}]}}},{type:"expandable",name:"display",title:this._t("section_display"),flatten:!0,schema:[{name:"hide_header",selector:{boolean:{}}},{name:"show_rack",selector:{boolean:{}}},{name:"show_legend",selector:{boolean:{}}},{name:"show_battery",selector:{boolean:{}}},{name:"show_ebikes",selector:{boolean:{}}},{name:"show_docks",selector:{boolean:{}}},{name:"show_flags",selector:{boolean:{}}},{name:"show_timestamp",selector:{boolean:{}}},{name:"show_rent_button",selector:{boolean:{}}},{name:"hide_attribution",selector:{boolean:{}}}]}]}_formData(){const e=(this._config.entities??[]).map(e=>e.entity).filter(e=>"string"==typeof e&&e.length>0);return{...this._config,entities:e}}render(){return this._config?F`
    ...
    `:I}constructor(...e){super(...e),this._config={type:"nextbike-austria-card",entities:[]},this._computeLabel=e=>{const t=`ui.panel.lovelace.editor.card.generic.${e.name}`,i=this.hass?.localize?.(t);if(i)return i;const s=this._t(e.name);return s!==e.name?s:e.name},this._computeHelper=e=>{const t=`${e.name}_helper`,i=this._t(t);return i===t?void 0:i},this._onFormChanged=e=>{const t=e.detail.value,i=t.entities,s=Array.isArray(i)?i.filter(e=>"string"==typeof e&&e.length>0).map(e=>({entity:e})):[],n=ke({...t,entities:s});this._config=n,function(e,t,i){const s=new CustomEvent(t,{detail:i,bubbles:!0,composed:!0});e.dispatchEvent(s)}(this,"config-changed",{config:n})}}}function Te(e,t,i,s){var n,r=arguments.length,a=r<3?t:s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a}Ce([he({attribute:!1})],ze.prototype,"hass",void 0),Ce([pe()],ze.prototype,"_config",void 0),ze=Ce([le("nextbike-austria-card-editor")],ze);class Re extends ae{static{this.styles=_e}setConfig(e){if(null===e||"object"!=typeof e||Array.isArray(e))throw new Error("nextbike-austria-card: config must be an object");this._config=ke(e)}connectedCallback(){super.connectedCallback(),this._tickTimer||(this._tickTimer=setInterval(()=>{this._tickKey++},6e4))}disconnectedCallback(){super.disconnectedCallback(),this._tickTimer&&(clearInterval(this._tickTimer),this._tickTimer=null)}willUpdate(e){if(this._resolvedEntitiesMemo=null,e.has("hass")&&this.hass&&!this._versionChecked&&(this._versionChecked=!0,this._checkCardVersion()),e.has("_config")||e.has("hass")){const e=this._resolveEntities();"tabs"===this._config.layout&&e.length>=2&&this._activeTab>=e.length&&(this._activeTab=0)}}shouldUpdate(e){if(!this._config)return!1;if(e.has("_config")||e.has("_activeTab")||e.has("_versionMismatch")||e.has("_tickKey"))return!0;if(!e.has("hass"))return!1;const t=e.get("hass");if(!t)return!0;if(!this.hass)return!1;return this._resolveEntities(this.hass,!1).some(e=>t.states[e.entity]!==this.hass.states[e.entity])}getCardSize(){const e=this.hass?this._resolveEntities().length||1:this._config.entities.length||1;return Math.min(12,3+3*e)}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}static async getConfigElement(){return document.createElement("nextbike-austria-card-editor")}static getStubConfig(e){const t=we(e)[0];return{entities:t?[{entity:t}]:[]}}async _checkCardVersion(){this._versionMismatch=await async function(e,t,i){if(!e?.callWS)return null;try{const s=await e.callWS({type:t});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"nextbike_austria/card_version","1.3.2")}_t(e){return function(e,t){const i=ge(e);return fe(be[i]??be.en,[t])??fe(be.en,[t])??t}(this.hass,e)}_resolveEntities(e=this.hass,t=!0){const i=t&&e===this.hass;if(i&&null!==this._resolvedEntitiesMemo)return this._resolvedEntitiesMemo;const s=Array.isArray(this._config?.entities)?this._config.entities.filter(t=>e?.states[t.entity]):[];let n;if(s.length)n=s;else{const t=we(e)[0];n=t?[{entity:t}]:[]}return i&&(this._resolvedEntitiesMemo=n),n}render(){if(!this.hass||!this._config)return I;const e=this._resolveEntities(),t="tabs"===this._config.layout&&e.length>=2,i=e.map(e=>this.hass?.states[e.entity]?.attributes?.attribution).find(e=>"string"==typeof e&&e.length>0)||"Data: nextbike GmbH, CC0-1.0";let s;if(e.length)if(t){const t=e[this._activeTab]??e[0];s=this._renderStation(t,this._activeTab)}else s=e.map(e=>this._renderStation(e));else s=this._renderEmpty();return F`
      <ha-card>
        ${t?this._renderTabs(e):I}
        <div class="wrap">
          ${me(this._versionMismatch,e=>this._t(e))}
          ${s}
          ${this._config.hide_attribution?I:F`<div class="attr">${i}</div>`}
        </div>
      </ha-card>
    `}_renderEmpty(){const e=we(this.hass).length?"no_entities_picked":"no_entities_available";return F`<div class="empty-state" role="status">${this._t(e)}</div>`}_renderTabs(e){return F`
      <div class="tabs" role="tablist">
        ${e.map((t,i)=>{const s=this.hass?.states[t.entity]?.attributes||{},n="string"==typeof s.friendly_name&&s.friendly_name.length>0,r=Se(s,t.entity),a=i===this._activeTab;return F`
            <button
              type="button"
              role="tab"
              id=${`nbtab-${i}`}
            ...
            >
              ${n?F`<span lang="de">${r}</span>`:r}
            </button>
          `})}
      </div>
    `}_setActiveTab(e){Number.isFinite(e)&&e!==this._activeTab&&(this._activeTab=e)}_onTabKeydown(e,t,i){let s=t;switch(e.key){case"ArrowRight":s=(t+1)%i;break;case"ArrowLeft":s=(t-1+i)%i;break;case"Home":s=0;break;case"End":s=i-1;break;default:return}e.preventDefault(),this._setActiveTab(s),this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelectorAll('.tabs [role="tab"]');e?.[s]?.focus()})}_renderStation(e,t){const i=this.hass?.states[e.entity];if(!i)return F`<div class="empty-state" role="status">${this._t("no_entities_unavailable")}</div>`;const s=i.attributes||{},n=parseInt(i.state,10),r=Number.isFinite(n)?Math.max(0,n):0,a="number"==typeof s.capacity?s.capacity:null,o="number"==typeof s.num_docks_available?s.num_docks_available:null,l=function(e){const t=e?.vehicle_types_available;if(!Array.isArray(t))return null;const i=ye(e);let s=0;for(const e of t){if(!e||"object"!=typeof e)continue;const t=e,n=String(t.vehicle_type_id??""),r=t.count;i.has(n)&&"number"==typeof r&&Number.isFinite(r)&&(s+=r)}return s}(s),c="number"==typeof s.e_bike_avg_battery_pct?s.e_bike_avg_battery_pct:null,d="number"==typeof s.e_bike_range_samples?s.e_bike_range_samples:0,h=Array.isArray(s.e_bike_battery_list)?s.e_bike_battery_list:null,p=s.vehicle_type_names&&"object"==typeof s.vehicle_type_names?s.vehicle_type_names:{},u=Array.isArray(s.vehicle_types_available)?s.vehicle_types_available:[],b=ye(s),g="number"==typeof s.bikes_reserved?s.bikes_reserved:0,f=Array.isArray(s.bikes_reserved_types)?s.bikes_reserved_types:[],m="number"==typeof s.bikes_disabled?s.bikes_disabled:0,_=Array.isArray(s.bikes_disabled_types)?s.bikes_disabled_types:[],v=s.system_id||"",y=ue[v]||"var(--primary-color)",x="string"==typeof s.system_label&&s.system_label||v.replace(/^nextbike_/,""),w=xe(s.rental_uri),$="string"==typeof s.friendly_name&&s.friendly_name.length>0,k=Se(s,e.entity),A="number"==typeof s.latitude&&"number"==typeof s.longitude&&xe(`https://www.google.com/maps/search/?api=1&query=${s.latitude},${s.longitude}`)||null,S=1===r?this._t("bike"):this._t("bikes"),E=this._renderPills(l,o,a),C="number"==typeof t;return F`
      <section
        class="station"
        aria-label=${k}
        role=${C?"tabpanel":I}
        id=${C?`nbpanel-${t}`:I}
        aria-labelledby=${C?`nbtab-${t}`:I}
        tabindex=${C?"-1":I}
        style=${`--nb-accent:${y};`}
      >
        ${this._config.hide_header?I:F`<header class="header">
              <div class="icon-tile" aria-hidden="true">
                <ha-icon icon="mdi:bicycle"></ha-icon>
              </div>
              <div class="header-text">
                <h2 class="title">
                  ${$?F`<span lang="de">${k}</span>`:k}
                </h2>
    ...
    `}_renderPills(e,t,i){const s=[];if(this._config.show_ebikes&&"number"==typeof e&&Number.isFinite(e)&&e>0&&s.push(F`
      ...
      `)}return s}_renderRack(e){const{bikes:t,ebikes:i,capacity:s,accent:n,batteryPct:r,batterySamples:a,batteryList:o,vehicleTypesAvailable:l,vehicleTypeNames:c,ebikeIds:d,reservedCount:h,reservedTypes:p,disabledCount:u,disabledTypes:b}=e,g=s,f=Math.min(t,s),m=Math.min(h,Math.max(0,g-f)),_=Math.min(u,Math.max(0,g-f-m)),v="number"==typeof i&&Number.isFinite(i)&&i>0,y=v?Math.min(f,i):0,x=!!this._config.show_battery&&"number"==typeof r&&a>0,w=x&&Array.isArray(o)?o:[],$=v||g>0,k=$?function(e,t,i){if(!Array.isArray(e))return null;for(const s of e){const e=String(s?.vehicle_type_id??"");if(i.has(e)&&t?.[e])return t[e]}return null}(l,c,d):null,A=$?function(e,t,i){const s=[];if(!Array.isArray(e))return s;for(const n of e){const e=String(n?.vehicle_type_id??""),r="number"==typeof n?.count&&Number.isFinite(n.count)?n.count:0;if(i.has(e)||r<=0)continue;const a=t?.[e]||"";for(let e=0;e<r;e++)s.push(a)}return s}(l,c,d):[];let S=0;const E=[];for(let e=0;e<f;e++){if(e<y){const t=w[e]||null,i=t?.type||k||this._t("legend_ebike");if(t&&x&&"number"==typeof t.pct){const e=t.pct,s=Ae(e),n=`${i} · ${Math.round(e)}%`;E.push(F`
            <div
              ...
              title=${n}
            ></div>
          `)}else{const e=x?`${i} · ${this._t("battery_unknown")}`:i;E.push(F`
            <div
              ...
              title=${e}
            ></div>
          `)}}else{const e=A[S++]||this._t("legend_bike");E.push(F`
          <div
            class="slot filled"
            role="img"
            aria-label=${e}
            ...
            title=${e}
          ></div>
        `)}}const C=this._t("reserved");for(let e=0;e<m;e++){const t=p?.[e],i=t?`${t} · ${C}`:C;E.push(F`
        <div
          class="slot reserved"
          role="img"
          aria-label=${i}
      ...
      `)}const z=this._t("disabled");for(let e=0;e<_;e++){const t=b?.[e],i=t?`${t} · ${z}`:z;E.push(F`
        <div
          class="slot disabled"
          role="img"
          aria-label=${i}
      ...
      `)}for(let e=f+m+_;e<g;e++){const e=this._t("legend_empty");E.push(F`
        <div
          class="slot empty"
          role="img"
          aria-label=${e}
          title=${e}
        ></div>
      `)}const T=t>s,R=f+m+_<g,P=m>0,M=_>0,H=this._t("rack_summary").replace("{available}",String(f)).replace("{capacity}",String(s));return F`
      <div class="rack-block">
        ...
        ${this._config.show_legend?this._renderLegend({accent:n,hasEbikes:v,hasOverflow:T,hasEmptyVisible:R,battery:x&&"number"==typeof r?{pct:r,color:Ae(r)}:null,hasReservedVisible:P,hasDisabledVisible:M}):I}
      </div>
    `}_renderLegend(e){const{accent:t,hasEbikes:i,hasOverflow:s,hasEmptyVisible:n,battery:r,hasReservedVisible:a,hasDisabledVisible:o}=e,l=[F`
        <div class="legend-item">
          <dt class="legend-swatch" style=${`background:${t}`} aria-hidden="true"></dt>
          <dd>${this._t("legend_bike")}</dd>
        </div>
      `];if(i){const e=r?"background:linear-gradient(to top, #2ecc71 70%, color-mix(in srgb, #2ecc71 15%, transparent) 70%);outline:1px solid color-mix(in srgb, #2ecc71 60%, transparent);outline-offset:-1px;":`background:linear-gradient(135deg, ${t} 0%, ${t} 55%, #ffd740 55%, #ffd740 100%);`;l.push(F`
        <div class="legend-item">
      ...
      `),F`<dl class="legend">${l}</dl>`}_renderFlags(e){const t=[];return!1===e.is_installed&&t.push(F`
        <span class="flag err">
          <ha-icon icon="mdi:alert-circle"></ha-icon>${this._t("offline")}
        </span>
      `),!1===e.is_renting&&t.push(F`
        <span class="flag warn">
          <ha-icon icon="mdi:cancel"></ha-icon>${this._t("no_rental")}
        </span>
      `),!1===e.is_returning&&t.push(F`
        <span class="flag warn">
          <ha-icon icon="mdi:cancel"></ha-icon>${this._t("no_return")}
        </span>
      `),!0===e.is_virtual_station&&t.push(F`
        <span class="flag">
          <ha-icon icon="mdi:map-marker-radius"></ha-icon>${this._t("virtual_station")}
        </span>
      `),t.length?F`<div class="flags">${t}</div>`:I}_renderFooter(e,t){const i=!!this._config.show_rent_button&&!!t,s=this._config.show_timestamp?function(e,t){let i=null;if("number"==typeof e&&Number.isFinite(e))i=e>1e11?e/1e3:e;else if("string"==typeof e&&e.length>0){const t=Date.parse(e);Number.isFinite(t)&&(i=t/1e3)}if(null===i)return null;const s=Math.max(0,Math.floor(Date.now()/1e3-i));return s<10?t("now"):s<60?t("seconds_ago").replace("{n}",String(s)):s<3600?t("minutes_ago").replace("{n}",String(Math.floor(s/60))):t("hours_ago").replace("{n}",String(Math.floor(s/3600)))}(e.last_reported,e=>this._t(e)):null;return i||s?F`
      <div class="actions">
        ${i?F`
              <a
                class="btn-primary"
            ...
            `:I}
        ${s?F`<span class="timestamp"
              >${this._t("last_updated")} ${s}</span
            >`:I}
      </div>
    `:I}constructor(...e){super(...e),this._config={type:"nextbike-austria-card",entities:[]},this._activeTab=0,this._versionMismatch=null,this._tickKey=0,this._tickTimer=null,this._versionChecked=!1,this._resolvedEntitiesMemo=null}}Te([he({attribute:!1})],Re.prototype,"hass",void 0),Te([pe()],Re.prototype,"_config",void 0),Te([pe()],Re.prototype,"_activeTab",void 0),Te([pe()],Re.prototype,"_versionMismatch",void 0),Te([pe()],Re.prototype,"_tickKey",void 0),Re=Te([le("nextbike-austria-card")],Re);const Pe=window;Pe.customCards??=[],Pe.customCards.push({type:"nextbike-austria-card",name:"Nextbike Austria Card",description:"Station dashboard for nextbike-operated bike-sharing in Austria — bikes, docks, e-bikes, rental deep-link.",preview:!0,documentationURL:"https://github.com/rolandzeiner/nextbike-austria",getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"nextbike_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:nextbike-austria-card",entities:[{entity:t}]}}:null});
