...
from custom_components.nextbike_austria.const import CARD_VERSION

# Also guard against the string moving or the regex missing a match —
# both common flavours of silent test-pass.
